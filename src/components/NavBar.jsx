  ...
  return (
    <nav>
      ...
      <ul className={`sidebar ${isOpen ? "active" : ""}`}>
        ...
        <li><NavLink to="/about" onClick={()=>setIsOpen(false)}>À propos</NavLink></li>
        ...
        <li>
          <button className="btn-phone">Numéro</button>
        </li>
      </ul>
      ...
      <ul>
        ...
        <li className='hideOnMobile'>
          <button className="btn-phone "> <a href="tel:+33123456789">Numéro</a></button>
        </li>
