    ...
    <div className="contact-container">
      <div className="contact-header">
        ...
        <div className="contact-header-sidetext">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In id augue
            semper arcu enim lorem ipsum dolor sit amet, consectetur adipiscing
            elit.
          </p>
        </div>
      </div>
      ...
      <div className="contact-content">
        ...
        <div className="contact-content-info">
          <div className="contact-content-info-location">
            ...
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=3+Pl.+du+14+Juillet,+91270+Vigneux-sur-Seine"
              target="_blank"
